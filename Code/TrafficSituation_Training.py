...
num_of_samples = []
cols = 3 # This will display images
...
pickle_out = open("model_trained_01_03_2020_2.p", "wb")  # wb = WRITE BYTE
...
plt.xlabel('epoch')
plt.show()
plt.savefig('accuracy.png',bbox_inches='tight', dpi=150)
